...
To use these stylesheets, rename the files and openblog with the name of your theme.
...
openblog-alpha-default-narrow.css  
...
openblog-alpha-default-normal.css
...
openblog-alpha-default-wide.css
